...
2. **Analyses et explications des expériences** :
   Les analyses détaillées et les explications de nos expériences sont disponibles dans le fichier `experiments.pdf` (celu-ci). Veuillez vous y référer pour une compréhension approfondie de nos résultats.
